...
function from_candid_record_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        viewPassword: record_opt_to_undefined(from_candid_opt_n8(_uploadFile, _downloadFile, value.viewPassword)),
        description: value.description,
        githubUrl: value.githubUrl,
        imageUrl: value.imageUrl,
        demoUrl: value.demoUrl,
        techStack: value.techStack,
        demoPassword: record_opt_to_undefined(from_candid_opt_n8(_uploadFile, _downloadFile, value.demoPassword))
    };
}
...
function to_candid_record_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        title: value.title,
        featured: value.featured,
        viewPassword: value.viewPassword ? candid_some(value.viewPassword) : candid_none(),
        description: value.description,
        githubUrl: value.githubUrl,
        imageUrl: value.imageUrl,
        demoUrl: value.demoUrl,
        techStack: value.techStack,
        demoPassword: value.demoPassword ? candid_some(value.demoPassword) : candid_none()
    };
}
